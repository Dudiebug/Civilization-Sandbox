...
- [ADR-004 - Configurable hierarchical world creation](ADR-004_CONFIGURABLE_HIERARCHICAL_WORLD_CREATION.md) - introduces creator-configured deterministic world generation and hybrid 2.5D geography in Build 02 while preserving multi-planet continuity for Build 20.
