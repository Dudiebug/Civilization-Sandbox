...
**Generated:** 2026-07-21 04:24 UTC
**Roadmap revision:** ADR-001-lean-1.0
**Active implementation task:** TASK-003
**Completed implementation tasks:** 2 / 25
...
|---:|---|---:|---:|---:|---:|---:|---|
| 0.1 | Project Foundation | 2 | 0 | 0 | 0 | 10 | Defined; not started |
...
- [x] ~~**TASK-002** — Source-of-truth, release-scope, story, and AI document set~~ — Milestone 0.1
