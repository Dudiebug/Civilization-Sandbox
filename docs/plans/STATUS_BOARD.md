...
**Generated:** 2026-07-21 00:06 UTC
...
|---:|---|---:|---:|---:|---:|---:|---|
| 0.1 | Project Foundation | 0 | 1 | 0 | 0 | 10 | Active |
...
- [~] **TASK-001** — Repository governance and reproducible bootstrap — **IN PROGRESS** — Milestone 0.1
