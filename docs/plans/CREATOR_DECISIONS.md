...
- Repository: private GitHub repository `Dudiebug/Civilization-Sandbox`, protected `main`, task branches, and sibling worktrees as specified in `Config/repository-governance.json`.
