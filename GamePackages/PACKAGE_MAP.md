...
Build 02 additionally activates bounded deterministic world settings, person-scale semantic terrain cells and biomes, stable generated-world/region identity, ten deterministic source-resource fields, a read-only crisp top-down/angled world preview, founding-site selection, survival needs, and the first conserved camp loop: bounded source reservations, real travel, finite gathering, carrying, shared stockpiles, consumption, and one material-and-labor shelter project. Processing recipes, hydrology, mature environments, wildlife populations, roads, crop systems, and multi-planet runtime remain reserved for their connected slices.
